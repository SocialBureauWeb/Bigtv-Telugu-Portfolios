...
// Auto-looping GravityText — blocks fall, text reveals, then resets and repeats.
...
export default function GravityText({
  ...
  const runPhysicsLoop = useCallback(() => {
    ...
    if (hasActiveAnimations) {
      ...
      // All blocks off-screen — schedule auto-reset
  ...
  // Scroll-intersection observer — kick off the loop on first view
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      {/* Manual trigger — only shown before the first scroll-trigger fires */}
