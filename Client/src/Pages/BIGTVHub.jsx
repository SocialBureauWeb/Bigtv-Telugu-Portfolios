              ...
              >
                {item.image ? (
                  <img
                    src={item.image}
                    alt={item.name}
                    className={`w-full h-full object-cover object-top scale-[1.08] transition-all duration-500 ${
          ...
          return (
            ...
            >
              ...
              {item.image ? (
                <img
                  ...
                  className={`w-full h-full object-cover object-top transition-all duration-700 ${
                    isLocked ? 'grayscale opacity-30' : isActive ? 'grayscale-0 scale-100' : 'grayscale opacity-50 scale-105'
                  }`}
                />
              ) : (
                <div
              ...
              <div className={`absolute top-2 right-2 w-2.5 h-2.5 rounded-full border border-black/40 ${
                isLocked ? 'bg-amber-500' : 'bg-emerald-400'
              }`} />
...
const teluguLetters = [
  { char: "అ", top: "15%", left: "8%", size: "1.2rem", rotate: 12, floatY: -8, duration: 6, delay: 0.2, opacity: 0.22 },
  { char: "ఆ", top: "22%", left: "18%", size: "0.9rem", rotate: -8, floatY: -6, duration: 5, delay: 0.5, opacity: 0.25 },
  { char: "ఇ", top: "45%", left: "5%", size: "1.4rem", rotate: 15, floatY: -10, duration: 7, delay: 0.1, opacity: 0.18 },
  { char: "ఉ", top: "72%", left: "10%", size: "1.1rem", rotate: -12, floatY: -8, duration: 8, delay: 0.7, opacity: 0.22 },
  { char: "క", top: "25%", left: "85%", size: "1.6rem", rotate: -15, floatY: -12, duration: 9, delay: 0.4, opacity: 0.20 },
  { char: "ఖ", top: "12%", left: "76%", size: "0.8rem", rotate: 20, floatY: -5, duration: 5.5, delay: 0.9, opacity: 0.28 },
  { char: "గ", top: "40%", left: "82%", size: "1.3rem", rotate: -10, floatY: -9, duration: 7.2, delay: 0.3, opacity: 0.22 },
  { char: "ఘ", top: "60%", left: "88%", size: "1.5rem", rotate: 8, floatY: -11, duration: 8.5, delay: 0.6, opacity: 0.18 },
  { char: "చ", top: "82%", left: "80%", size: "1.1rem", rotate: -18, floatY: -7, duration: 6.8, delay: 0.2, opacity: 0.25 },
  { char: "ఛ", top: "70%", left: "28%", size: "1.4rem", rotate: 25, floatY: -12, duration: 7.8, delay: 0.8, opacity: 0.20 },
  { char: "జ", top: "85%", left: "20%", size: "0.9rem", rotate: -5, floatY: -5, duration: 5.2, delay: 0.15, opacity: 0.26 },
  { char: "ట", top: "18%", left: "32%", size: "1.2rem", rotate: 14, floatY: -7, duration: 6.4, delay: 0.45, opacity: 0.21 },
  { char: "త", top: "8%", left: "42%", size: "1.5rem", rotate: -16, floatY: -10, duration: 8.2, delay: 0.75, opacity: 0.18 },
  { char: "ద", top: "78%", left: "45%", size: "1.3rem", rotate: 15, floatY: -9, duration: 7.4, delay: 0.35, opacity: 0.23 },
  { char: "న", top: "52%", left: "55%", size: "1.0rem", rotate: -8, floatY: -6, duration: 6.2, delay: 0.95, opacity: 0.25 },
  { char: "ప", top: "30%", left: "64%", size: "1.7rem", rotate: 10, floatY: -12, duration: 8.8, delay: 0.55, opacity: 0.19 },
  { char: "భ", top: "10%", left: "92%", size: "0.9rem", rotate: 22, floatY: -5, duration: 5.8, delay: 0.85, opacity: 0.28 },
  { char: "మ", top: "62%", left: "70%", size: "1.4rem", rotate: -12, floatY: -9, duration: 7.6, delay: 0.65, opacity: 0.22 },
  { char: "య", top: "35%", left: "48%", size: "1.1rem", rotate: 5, floatY: -7, duration: 6.0, delay: 0.12, opacity: 0.24 },
  { char: "ర", top: "5%", left: "22%", size: "1.5rem", rotate: -18, floatY: -11, duration: 8.0, delay: 0.38, opacity: 0.19 },
  { char: "ల", top: "58%", left: "15%", size: "1.0rem", rotate: 10, floatY: -6, duration: 6.6, delay: 0.48, opacity: 0.23 },
  { char: "వ", top: "48%", left: "25%", size: "1.3rem", rotate: -15, floatY: -8, duration: 7.0, delay: 0.58, opacity: 0.21 },
  { char: "శ", top: "90%", left: "35%", size: "1.2rem", rotate: 8, floatY: -9, duration: 7.5, delay: 0.28, opacity: 0.22 },
  { char: "ష", top: "5%", left: "58%", size: "0.9rem", rotate: -10, floatY: -5, duration: 5.4, delay: 0.68, opacity: 0.27 },
  { char: "స", top: "25%", left: "70%", size: "1.4rem", rotate: 12, floatY: -10, duration: 8.4, delay: 0.78, opacity: 0.20 },
  { char: "హ", top: "92%", left: "58%", size: "1.1rem", rotate: -20, floatY: -8, duration: 6.9, delay: 0.88, opacity: 0.24 },
  { char: "ళ", top: "75%", left: "68%", size: "1.3rem", rotate: 15, floatY: -9, duration: 7.1, delay: 0.08, opacity: 0.22 },
  { char: "క్ష", top: "48%", left: "95%", size: "1.0rem", rotate: -12, floatY: -7, duration: 6.3, delay: 0.18, opacity: 0.25 },
  { char: "ఱ", top: "35%", left: "98%", size: "1.5rem", rotate: 18, floatY: -11, duration: 8.1, delay: 0.22, opacity: 0.19 }
];
...
export default function BIGTVHub() {
  ...
  const customCorres = registeredCorres.filter(u => 
    u.email.toLowerCase() !== 'ganesh@bigtv.com' && 
    u.email.toLowerCase() !== 'aparna@bigtv.com' && 
    u.email.toLowerCase() !== 'arya@bigtv.com' && 
    u.email.toLowerCase() !== 'binil@bigtv.com' && 
    u.email.toLowerCase() !== 'ramadevi@bigtv.com' && 
    u.email.toLowerCase() !== 'rema@bigtv.com' && 
    u.email.toLowerCase() !== 'sheik@bigtv.com' && 
    u.email.toLowerCase() !== 'admin@bigtv.com'
  )
  ...
  const ramadeviDivision = ramadeviDbData ? ramadeviDbData.division : 'Associate Editor'
  const ramadeviBio = ramadeviDbData ? ramadeviDbData.bio : 'Associate Editor at BIG TV with over 15 years of experience in television journalism. Has served in leading news organizations including NTV and Express TV, bringing extensive expertise in editorial planning, newsroom operations, content strategy, and broadcast journalism.'
  const ramadeviStatus = ramadeviDbData ? ramadeviDbData.status : 'LIVE RECORD'

  const sheikDbData = registeredCorres.find(u => u.email.toLowerCase() === 'sheik@bigtv.com')
  const sheikName = sheikDbData ? sheikDbData.name : 'Shaik Sartaj'
  const sheikDivision = sheikDbData ? sheikDbData.division : 'Coordinating Editor'
  const sheikBio = sheikDbData ? sheikDbData.bio : 'Coordinating Editor based in Hyderabad. Amplifying public issues, holding power accountable, and championing environmental conservation.'
  const sheikStatus = sheikDbData ? sheikDbData.status : 'LIVE RECORD'
  ...
  const spotlightItems = [
    ...
    },
    {
      ...
      name: ramadeviName,
      shortName: 'MARYADA',
      role: ramadeviDivision,
      nationality: 'INDIA',
      primaryColor: '#2563eb',
      image: ramadeviImg,
      status: ramadeviStatus,
      aesthetic: 'Editorial Leadership & Newsroom Management',
      bio: ramadeviBio,
      quote: 'Credibility is earned through accuracy, integrity, and unwavering commitment to the truth.',
      keyWorks: [
        { title: 'Associate Editor', genre: 'BIG TV Network', year: '2022 — Present' },
        { title: 'News Editor', genre: 'Express TV', year: '2014 — 2016' },
        { title: 'Newsroom & Editorial Operations', genre: 'NTV', year: '2007 — 2014' }
      ],
      link: '#/ramadevi'
    },
    {
    ...
    },
    {
      ...
      image: sheikImg,
      status: sheikStatus,
      aesthetic: 'Ethical & Fact-Driven Broadcast Journalism',
      bio: sheikBio,
      quote: 'Ethical storytelling is the cornerstone of trust in regional and national broadcasting.',
      keyWorks: [
        { title: 'Public Issues & Governance Reporting', genre: 'Broadcast Journalism', year: 'Present' },
        { title: 'Animal Welfare & Green Campaigns', genre: 'Social Advocacy', year: '2024 — Present' },
        { title: 'Telangana Governance Debates', genre: 'Anchor', year: '2025' }
      ],
      link: '#/sheik'
    },
  ...
  const tickerItems = [
    "BIG TV TELUGU EDITORIAL DEPLOYMENT V4.0.1",
  ...
  return (
    <div className="min-h-screen bg-white text-[#10141a] relative font-body selection:bg-[#e30613] selection:text-white antialiased">
      ...
      >
        <nav className="flex justify-between items-center max-w-container-max mx-auto px-6 md:px-margin-desktop h-12 w-full relative">
          ...
          <div className="flex items-center gap-3">
            <a href="#/">
              <img src={logoImg} alt="BIG TV Telugu" className="h-10 w-auto object-contain rounded cursor-pointer" />
            </a>
          </div>
      ...
      >
        ...
        {/* Scattered Telugu Alphabets — organic continuous float */}
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 select-none">
          {teluguLetters.map((item, idx) => (
            <motion.div
              key={idx}
              ...
              style={{
                ...
                opacity: activeCorres && activeCorres.id === 'ganesh' ? Math.min(item.opacity * 2.8, 0.75) : item.opacity
              }}
              animate={{
      ...
      <section id="network-leaders" className="relative w-full py-12 md:py-24 overflow-hidden flex flex-col items-center" style={{ background: 'linear-gradient(135deg, #0f0c29 0%, #1a1a2e 40%, #16213e 70%, #0f3460 100%)' }}>
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="absolute top-[-10%] left-[10%] w-[500px] h-[500px] rounded-full opacity-20 blur-[100px]" style={{ background: 'radial-gradient(circle, #2563eb, transparent)' }} />
          ...
          <div className="absolute bottom-[0%] left-[30%] w-[450px] h-[450px] rounded-full opacity-15 blur-[100px]" style={{ background: 'radial-gradient(circle, #f59e0b, transparent)' }} />
          <div className="absolute bottom-[10%] right-[25%] w-[350px] h-[350px] rounded-full opacity-15 blur-[80px]" style={{ background: 'radial-gradient(circle, #c5a880, transparent)' }} />
        </div>
        ...
        <div className="w-full max-w-container-max mx-auto px-margin-desktop text-center mb-6 md:mb-16 relative z-10">
          <span className="font-mono text-[10px] tracking-[0.3em] uppercase text-white/40 font-semibold">BIG TV Telugu</span>
        ...
        <div className="border-t border-slate-800">
          <div className="max-w-container-max mx-auto px-margin-desktop py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
            <span className="font-mono text-[9px] uppercase tracking-[0.25em] text-slate-600">
              © {new Date().getFullYear()} BIG TV Telugu. All rights reserved.
            </span>
