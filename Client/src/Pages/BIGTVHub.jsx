...
export default function BIGTVHub() {
  ...
  const spotlightItems = [
    ...
    },
    {
        ...
        bio: 'Associate Editor at BIG TV Malayalam with over 15 years of experience in television journalism. Has served in leading news organizations including NTV and Express TV, bringing extensive expertise in editorial planning, newsroom operations, content strategy, and broadcast journalism.',
        quote: 'Credibility is earned through accuracy, integrity, and unwavering commitment to the truth.',
        keyWorks: [
          {
            title: 'Associate Editor',
            genre: 'BIG TV Malayalam',
            year: '2022 — Present'
          },
          {
            title: 'News Editor',
          ...
          {
            title: 'Newsroom & Editorial Operations',
            genre: 'NTV',
            year: '2007 — 2014'
          }
        ],
        ...
        <div className="w-full h-[580px] relative z-10">
          <DiagonalCarousel
            items={[
              ...
              { src: ramadeviImg, title: "Maryada Ramadevi", link: "#/ramadevi" },
